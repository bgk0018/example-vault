...
description: The science of physical training, endurance, strength, and recovery.
dg-publish: true
modified-dates:
  - "[[2025-07-01]]"
  - "[[2026-04-15]]"
...
A map collecting concepts, references, and projects related to the science of physical training. Topics include endurance, strength training, recovery, sleep, periodization, and the psychology of performance. The central governor theory — the idea that the brain, not the body, is the ultimate limiter of performance — is a recurring theme across many of these notes.
