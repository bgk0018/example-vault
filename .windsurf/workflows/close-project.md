...
This connects to the **Session Retrospective** in `global-conventions.md`. Present recommendations as specific, actionable suggestions — e.g., "Add a `stakeholders:` property to the project template" not "Consider improving the process."
